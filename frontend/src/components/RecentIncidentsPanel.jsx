...
export default function RecentIncidentsPanel() {
  ...
  if (collapsed) {
    return (
      <button
        ...
        className="relative flex flex-col items-center gap-3 px-2 py-4 bg-slate-900 border border-slate-800 rounded-2xl text-slate-400 hover:text-white hover:border-slate-700 transition flex-shrink-0"
      >
  ...
  return (
    ...
    <div className="w-80 flex-shrink-0 bg-slate-900 border border-slate-800 rounded-2xl flex flex-col h-full overflow-hidden">
          ...
          >
            <div className="px-4 py-2">
              <input
                ...
                autoFocus
                className="w-full px-3 py-2 text-sm rounded-lg bg-slate-950 border border-slate-700 text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            </div>
          </motion.div>
        )}
      ...
      <div className="px-4 py-2 border-b border-slate-800 flex gap-1.5 flex-wrap flex-shrink-0">
      ...
      {/* STATUS FILTER — fixed */}
      <div className="px-4 py-2 border-b border-slate-800 flex gap-1.5 flex-shrink-0">
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-slate-800 min-h-0">
        {filteredIncidents.length === 0 ? (
          ...
          filteredIncidents.map((item) => (
            <div
              ...
              className={`p-4 cursor-pointer hover:bg-slate-800/60 transition-colors space-y-2 ${
